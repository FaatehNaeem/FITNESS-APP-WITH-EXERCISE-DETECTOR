...
export default function BalanceOnRightLeg() {
    ...
    const exercise = "balance_leg_right";
                        ...
                        <>
                            ...
                            {poseTrackerInfos?.ready === false ? (
                                ...
                                <>
                                    ...
                                    <Text style={styles.para}>Placement info : You can start balancing on your right leg 🏋️</Text>
                                </>
                            )}
                        </>
                    ) : (
